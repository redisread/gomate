...
> 注意：本版本修正了页面数量、组件路径与已删除/新增页面，POI/路线相关页面已移除，新增发现/收藏/消息等功能模块。

## 概览

前端共 **32 个页面**，按功能分为 12 个模块：
...
### 编辑发现 `/discover/[id]/edit`、`/discover/create`

**组件：** `pages/discover/[id]/edit.astro`、`pages/discover/create.astro`
**认证要求：** 是
