/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=frontend/wrangler.jsonc --env=production api/src/worker-configuration.d.ts` (hash: 58b6be6135ed8e3a17ca1092516d05fb)
// Runtime types generated with workerd@1.20260611.1 2026-06-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	CACHE_KV: KVNamespace;
	R2: R2Bucket;
	DB: D1Database;
	AUTH_SIGN_IN_RATE_LIMITER: RateLimit;
	AUTH_SIGN_UP_RATE_LIMITER: RateLimit;
	AUTH_EMAIL_RATE_LIMITER: RateLimit;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../frontend/src/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_URL" | "RESEND_FROM_EMAIL" | "WRITE_MODE" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY" | "APP_URL">> {}
}
