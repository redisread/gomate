  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-5">
        ...
        <h3
          title={title}
          className="text-lg font-bold text-foreground line-clamp-2 mb-3 group-hover:text-primary transition-colors"
        >
          {title}
        </h3>
        ...
        <div className="flex items-center gap-2 pt-4 border-t border-border/40 min-w-0">
          ...
          {story.location && (
            <span
              ...
              className="ml-auto text-xs text-primary/80 bg-primary/5 px-2 py-0.5 rounded truncate max-w-[40%]"
            >
              {story.location.name}
            </span>
          )}
