/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=production src/server/worker-configuration.d.ts` (hash: acfcb0a390fc39c4644ca50d369e5d43)
