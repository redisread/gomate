/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=production src/server/worker-configuration.d.ts` (hash: 2c21102a9159d356c554f506b3a98ee2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "R2_PUBLIC_URL" | "RESEND_FROM_EMAIL" | "WRITE_MODE" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY">> {}
}
