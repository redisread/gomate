/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=production src/server/worker-configuration.d.ts` (hash: cd8583210daef57fbf853eb2414ef5de)
// Runtime types generated with workerd@1.20260820.1 2026-06-18 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "PREVIEW_HOST_SUFFIX" | "R2_PUBLIC_URL" | "RESEND_FROM_EMAIL" | "WRITE_MODE" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY">> {}
}
