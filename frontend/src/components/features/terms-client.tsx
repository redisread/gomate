  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-900">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        {/* 章节1：接受条款 */}
        <section>
          <h2 className="text-lg font-semibold text-amber-700 dark:text-amber-400 mb-3 mt-8">1. 接受条款</h2>
        ...
        {/* 章节2：服务描述 */}
        <section>
          <h2 className="text-lg font-semibold text-amber-700 dark:text-amber-400 mb-3 mt-8">2. 服务描述</h2>
        ...
        {/* 章节3：用户账号 */}
        <section>
          <h2 className="text-lg font-semibold text-amber-700 dark:text-amber-400 mb-3 mt-8">3. 用户账号</h2>
          <ul className="list-disc list-inside space-y-1 text-stone-600 dark:text-stone-400">
        ...
        {/* 章节4：用户行为准则 */}
        <section>
          <h2 className="text-lg font-semibold text-amber-700 dark:text-amber-400 mb-3 mt-8">4. 用户行为准则</h2>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed mb-3">使用 GoMate 时，您不得：</p>
          <ul className="list-disc list-inside space-y-1 text-stone-600 dark:text-stone-400">
            <li>发布虚假、误导性的队伍信息</li>
            <li>骚扰、威胁或伤害其他用户</li>
            <li>发布违法或侵权内容</li>
        ...
        {/* 章节5：内容所有权 */}
        <section>
          <h2 className="text-lg font-semibold text-amber-700 dark:text-amber-400 mb-3 mt-8">5. 内容所有权</h2>
          <ul className="list-disc list-inside space-y-1 text-stone-600 dark:text-stone-400">
        ...
        {/* 章节6：户外活动免责声明 */}
        <section>
          <h2 className="text-lg font-semibold text-amber-700 dark:text-amber-400 mb-3 mt-8">6. 户外活动免责声明</h2>
          <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 rounded-lg p-4">
            <p className="text-stone-600 dark:text-stone-400 leading-relaxed font-medium mb-3">重要提示：</p>
            <ul className="list-disc list-inside space-y-1 text-stone-600 dark:text-stone-400">
        ...
        {/* 章节7：服务变更与终止 */}
        <section>
          <h2 className="text-lg font-semibold text-amber-700 dark:text-amber-400 mb-3 mt-8">7. 服务变更与终止</h2>
          <ul className="list-disc list-inside space-y-1 text-stone-600 dark:text-stone-400">
        ...
        {/* 章节8：联系我们 */}
        <section>
          <h2 className="text-lg font-semibold text-amber-700 dark:text-amber-400 mb-3 mt-8">8. 联系我们</h2>
          <p className="text-stone-600 dark:text-stone-400 leading-relaxed">
            如对本服务条款有任何疑问，请联系：
          </p>
          <p className="text-stone-600 dark:text-stone-400 mt-2">
            邮箱：<a href="mailto:hello@gomate.live" className="text-amber-600 dark:text-amber-400 hover:underline">hello@gomate.live</a>
          </p>
        </section>
      </div>
    </div>
