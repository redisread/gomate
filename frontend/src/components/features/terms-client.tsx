    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="bg-stone-50 border-b border-stone-200">
        <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <nav className="text-sm text-stone-400 mb-6">
            ...
            <span className="text-stone-600">服务条款</span>
          </nav>
          <h1 className="text-3xl font-bold text-stone-800 mb-3">服务条款</h1>
          <p className="text-stone-500 mb-2">使用 GoMate 前，请仔细阅读以下条款</p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <section>
          ...
          <p className="text-stone-600 leading-relaxed mb-3">使用 GoMate 时，您不得：</p>
          <ul className="list-disc list-inside space-y-1 text-stone-600">
            <li>发布虚假、误导性的队伍信息</li>
            <li>骚扰、威胁或伤害其他用户</li>
            <li>发布违法或侵权内容</li>
        ...
        <section>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
            <p className="text-stone-600 leading-relaxed font-medium mb-3">重要提示：</p>
            <ul className="list-disc list-inside space-y-1 text-stone-600">
