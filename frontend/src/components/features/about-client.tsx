      ...
      <main className="flex-1">
        ...
        <div className="bg-stone-50 dark:bg-stone-900 border-b border-stone-200 dark:border-stone-700">
          <div className="max-w-3xl mx-auto px-6 py-10">
            ...
            <h1 className="text-3xl font-bold text-stone-900 dark:text-stone-100">{t("content.about.title")}</h1>
        ...
        <div className="max-w-3xl mx-auto px-6 py-12 space-y-10">
          ...
          {/* 核心特色 */}
          <section>
            <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-100 mb-4">{t("content.about.whatWeDo")}</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                {
                  icon: <MapPin className="w-5 h-5 text-amber-600 dark:text-amber-400" />,
                  title: t("content.about.featureDiscoverTitle"),
                  desc: t("content.about.featureDiscoverDesc"),
                },
                {
                  icon: <Users className="w-5 h-5 text-amber-600 dark:text-amber-400" />,
                  title: t("content.about.featureTeamTitle"),
                  desc: t("content.about.featureTeamDesc"),
                },
                {
                  icon: <Heart className="w-5 h-5 text-amber-600 dark:text-amber-400" />,
                  title: t("content.about.featureFavTitle"),
                  desc: t("content.about.featureFavDesc"),
                },
              ].map(({ icon, title, desc }) => (
                <div
                  key={title}
          ...
          <section className="bg-white dark:bg-stone-900 rounded-2xl border border-stone-200 dark:border-stone-700 shadow-sm px-8 py-8 text-center">
            <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100">{t("content.about.contactUs")}</h2>
