    ...
    <section id="teams" ref={teamsRef}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="inline-block mb-4 px-3 py-1 text-xs font-semibold rounded-full uppercase tracking-widest bg-amber-50/80 dark:bg-amber-950/30 text-amber-800 dark:text-amber-300">近期队伍</span>
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">{copy.teams.pageTitle}</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed text-lg">{copy.teams.pageSubtitle}</p>
        </div>
