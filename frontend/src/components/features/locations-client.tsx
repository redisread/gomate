      ...
      <article className="bg-white rounded-2xl overflow-hidden border border-stone-100 hover:border-stone-200 hover:shadow-lg hover:shadow-stone-200/60 transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-stone-100">
            ...
            <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-emerald-700 group-hover:text-emerald-600 transition-colors">
              查看详情
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 px-4">
      <div className="relative mb-6">
        ...
        <div className="absolute -bottom-1 -left-1 w-3 h-3 rounded-full bg-emerald-200" />
      </div>
      ...
      <button
        onClick={onClear}
        className="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full text-sm font-medium transition-all duration-200 shadow-md shadow-emerald-200 hover:-translate-y-0.5 active:scale-95"
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <input
              ...
              className="w-full pl-11 pr-12 py-3.5 bg-white/8 backdrop-blur-md text-white placeholder-stone-500 border border-white/10 rounded-xl focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/20 transition-all duration-200 text-sm"
            />
            {searchQuery && (
              <button
                type="button"
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  {selectedCityId && selectedCityName && (
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-full bg-emerald-50 text-emerald-700 border border-emerald-100">
                      <MapPin className="w-3 h-3" />
                      {selectedCityName}
                      <button onClick={() => handleCitySelect("")} className="hover:text-emerald-900 transition-colors ml-0.5">
                        <X className="w-3 h-3" />
                      </button>
                    </span>
                  )}
