...
function WechatContactModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        className="bg-popover dark:bg-stone-900 rounded-2xl w-full max-w-xs overflow-hidden shadow-xl"
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-3 w-7 h-7 flex items-center justify-center rounded-full text-stone-400 hover:text-stone-600 dark:hover:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors"
          aria-label="关闭"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        <div className="p-5">
          ...
          <div className="mb-5">
            <div className="flex items-center justify-center gap-2">
              <span
                className="text-base font-medium px-3 py-1.5 rounded-lg bg-stone-100 dark:bg-stone-800 text-foreground dark:text-stone-200"
              >
                {WECHAT_ID}
              </span>
            </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg font-medium text-sm border border-border dark:border-stone-700 text-stone-600 dark:text-stone-400 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
            >
