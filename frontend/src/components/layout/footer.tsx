        ...
        <div className="p-5">
          ...
          <div className="mb-5">
            <div className="flex items-center justify-center gap-2">
              <span
                className="text-base font-medium px-3 py-1.5 rounded-lg"
                style={{ background: "#F5F5F5", color: "#1c1917" }}
              >
                {WECHAT_ID}
              </span>
            </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg font-medium text-sm border transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
