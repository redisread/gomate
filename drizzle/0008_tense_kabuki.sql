...
CREATE INDEX `entity_to_pois_order_idx` ON `entity_to_pois` (`entity_id`,`order`);--> statement-breakpoint
...
CREATE INDEX `routes_duration_idx` ON `routes` (`duration_min`,`duration_max`);--> statement-breakpoint
CREATE INDEX `routes_distance_idx` ON `routes` (`distance`);--> statement-breakpoint
CREATE INDEX `routes_elevation_idx` ON `routes` (`elevation`);--> statement-breakpoint
