...
const sections = [
  {
    title: "1. 引言",
    content:
      "欢迎使用 GoMate。通过访问或使用我们的地点组队平台服务（以下简称「服务」），您同意受本服务条款（以下简称「条款」）的约束。在使用服务前，请仔细阅读本条款。",
  },
  {
    title: "2. 服务描述",
    content:
      "GoMate 是一个地点组队平台，帮助用户发现感兴趣的地点、组建队伍、找到同行伙伴。用户可以发布和加入活动，与志同道合的人建立连接。",
  },
  {
    title: "3. 用户义务",
    content: "使用我们的服务，您同意：",
  ...
  },
  {
    title: "6. 活动安全",
    content:
      "线下活动存在固有风险。您理解并同意：GoMate 仅提供信息交流平台，不对线下活动的安全负责。参与活动前，请根据自身情况做好充分准备。",
  },
  {
    title: "7. 知识产权",
    content:
